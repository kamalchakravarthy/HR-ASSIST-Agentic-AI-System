...
def seed_services(employee_manager, leave_manager, meeting_manager, ticket_manager):
    ...
    employees_data = [
        # Leadership
        {"emp_id": "E001", "name": "Ravi Kumar", "manager_id": None, "email": "ravi.kumar@tcs.com"},
        {"emp_id": "E002", "name": "Priya Nair", "manager_id": None, "email": "priya.nair@tcs.com"},

        # Delivery team under Ravi
        {"emp_id": "E003", "name": "Ankit Sharma", "manager_id": "E001", "email": "ankit.sharma@tcs.com"},
        {"emp_id": "E004", "name": "Sneha Iyer", "manager_id": "E003", "email": "sneha.iyer@tcs.com"},
        {"emp_id": "E005", "name": "Manoj Reddy", "manager_id": "E003", "email": "manoj.reddy@tcs.com"},

        # Consulting team under Priya
        {"emp_id": "E006", "name": "Kiran Patel", "manager_id": "E002", "email": "kiran.patel@tcs.com"},
        {"emp_id": "E007", "name": "Divya Menon", "manager_id": "E006", "email": "divya.menon@tcs.com"},
        {"emp_id": "E008", "name": "Rohit Verma", "manager_id": "E006", "email": "rohit.verma@tcs.com"},

        # HR & Admin team under Ravi
        {"emp_id": "E009", "name": "Neha Gupta", "manager_id": "E001", "email": "neha.gupta@tcs.com"},
        {"emp_id": "E010", "name": "Vikas Mehta", "manager_id": "E009", "email": "vikas.mehta@tcs.com"},
    ]
...
if __name__ == "__main__":
    ...
    print(employee_manager.search_employee_by_name("Vivek Reddy"))
